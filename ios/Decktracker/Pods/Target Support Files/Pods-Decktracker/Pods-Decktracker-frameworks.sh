...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-Decktracker/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework 'Appirater.framework'
  install_framework 'Bolts.framework'
  install_framework 'CAAnimation_EasingEquations.framework'
  install_framework 'CAAnimationBlocks.framework'
  install_framework 'CSStickyHeaderFlowLayout.framework'
  ...
  install_framework 'LMAlertView.framework'
